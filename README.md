...
In an on-going analysis, we compare word2vec-based semantic similarity between phrases to voxel pattern similarity derived from the hippocampus, anterior temporal lobe and specifically the temporal pole. We predicted semantic similarity representation in the anterior temporal lobe and the anterior hippocampus. We also predicted that pattern similarity will predict mnemonic discrimination performance in the anterior hippocampus and the temporal pole.
...
* **anat-preprocess/** - N4-bias-corrected anatomical images (T1-weighted \[brain-extracted as well] and proton density \[PD]).
...
* **registrations/** - Transform matrices and warps for affine and SyN registrations between various modalities.
